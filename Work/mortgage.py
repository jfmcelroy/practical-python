...
total_paid = 0.0
months = 0 
extra_payment_start_month = input('Enter extra payment start month')
extra_payment_end_month = input('Enter extra payment end month')
extra_payment = input('Enter extra payment amount')
